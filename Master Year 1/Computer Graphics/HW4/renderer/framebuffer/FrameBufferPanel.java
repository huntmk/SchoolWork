...
<p>
   ...
   {@code FrameBufferPanel} (which is a {@link JPanel}). Then the event
   listener will call the {@link javax.swing.JFrame}'s {@link java.awt.Component#repaint}
   method which will trigger this object's {@link #paintComponent} method.
   This will display the {@link java.awt.Image} (that holds the
   {@link FrameBuffer}'s contents) in the {@link JPanel} within the
...
public final class FrameBufferPanel extends JPanel
{
   ...
   */
   public FrameBufferPanel(final int fbWidth, final int fbHeight)
   {
      ...
      final FrameBuffer fb = new FrameBuffer(fbWidth, fbHeight);
