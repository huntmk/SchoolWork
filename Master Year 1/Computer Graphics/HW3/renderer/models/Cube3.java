...
public class Cube3 extends Cube
{
   ...
   */
   public Cube3(int xCount, int yCount, int zCount)
   {
      ...
      final double yStep = 2.0 / yCount;
      final double zStep = 2.0 / zCount;

      addVertex(new Vertex(0,  0,  1));
      final int centerFront = index++;
      addVertex(new Vertex(0,  0, -1));
      final int centerBack = index++;
      addVertex(new Vertex(0,  1,  0));
      final int centerTop = index++;
      addVertex(new Vertex(0, -1,  0));
      final int centerBottom = index++;
      addVertex(new Vertex( 1, 0,  0));
      final int centerRight = index++;
      addVertex(new Vertex(-1, 0,  0));
      final int centerLeft = index++;
