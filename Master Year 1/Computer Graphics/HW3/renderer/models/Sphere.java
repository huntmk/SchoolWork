...
public class Sphere extends Model
{
   ...
   */
   public Sphere(final double r, int n, int k)
   {
      super("Sphere");
      ...
      final Vertex southPole = new Vertex(0, -r, 0);
      ...
      final int southPoleIndex = northPoleIndex + 1;
