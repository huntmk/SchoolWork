/**
   ...
   A "label" for each node is stored as a Token.
...
public class Tree
{
   ...
   public Tree(Token element, Tree... subTrees) // variable number of arguments
   {
